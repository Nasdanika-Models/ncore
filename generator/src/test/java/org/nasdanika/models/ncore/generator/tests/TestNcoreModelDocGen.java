...
import org.nasdanika.models.ncore.processors.EcoreGenNcoreProcessorsFactory;
...
public class TestNcoreModelDocGen {
	...
	public void testGenerateNcoreModelDoc() throws IOException, DiagnosticException {
		List<EPackage> ePackages = Arrays.asList(EcorePackage.eINSTANCE, NcorePackage.eINSTANCE);
		...
		Map<EPackage, URI> packageURIMap = Map.ofEntries(
			...
			Map.entry(NcorePackage.eINSTANCE, baseActionURI)	
		);
